        ...
        {timelineData.map((event, index) => {
          ...
          return (
            <motion.div
              ...
              animate={inView ? { opacity: 1, y: 0 } : {}} // Animate to original position when in view
              transition={{ duration: 0.6, delay: index * 0.3 }} // Delay based on index
              className='flex flex-col md:flex-row items-center mb-12 relative w-full'
            >
              {/* Event content */}
