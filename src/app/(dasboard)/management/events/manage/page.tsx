  ...
  return (
    ...
    <div className="bg-[#a49845] w-full h-full min-h-[78vh] p-4">
      ...
      <div className='flex justify-between items-center mb-4'>
        <h2 className="text-xl font-semibold hidden md:block">Manage Events</h2>
        ...
        <table className="min-w-full table-auto border-collapse border border-gray-300">
          <thead className="bg-gray-100 sticky top-0 z-10">
            <tr>
              ...
              <th className="px-4 py-2 border border-gray-300 hidden md:table-cell">Place</th>
          ...
          <tbody>
            {Array.from({ length: 20 }).map((_, index) => (
              <tr key={index} className='hover:bg-slate-400'>
                ...
                <td className="px-4 py-2 border border-gray-300">Promotion</td>
                {/* Only visible on medium screens (md) and larger */}
                <td className="px-4 py-2 border border-gray-300 hidden md:table-cell">
                 Online
                </td>
                <td className="px-4 py-2 border border-gray-300 hidden md:table-cell">Pending</td>
